...
contract MyLwdSenvenToken1 is ERC721 {
  /*** CONSTANTS ***/

  string public constant name = "MyLwdSenvenToken1";
  string public constant symbol = "MLSTO";
  ...
  /**获取token属性**/
  function getToken(uint256 _tokenId) external view returns (address mintedBy, uint64 mintedAt,uint mintColor) {
